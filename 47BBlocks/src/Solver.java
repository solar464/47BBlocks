   ...
   public void printPath(Board last){
      ...
      while(!path.isEmpty()){
         ...
         if(current.getParent() != null){
            //base output
            if(printBase)
               System.out.println(moved.getPos() + " " + moved.getPos().add(dir));
   ...
   public static void main(String[] args) throws Exception{
      ...
      do {
          ...
          if (bVars == null) {
              ...
              initConfig.add (new Block(Integer.parseInt(bVars[0]),
      ...
      do {
          ...
          if (bVars == null) {
              ...
              goalConfig.add (new Block(Integer.parseInt(bVars[0]),
                    Integer.parseInt(bVars[1]), Integer.parseInt(bVars[3]),
                    Integer.parseInt(bVars[2])));
          }
      } while (true);
