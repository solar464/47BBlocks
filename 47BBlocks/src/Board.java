...
public class Board
{
   ...
   public Board makeMove(Block b, Pair direction){
      ...
      Board toReturn = null;
      Pair[] toFill = b.shouldBeEmpty(direction);
      Block moved;
      if(b.canMove(toFill, spaces)){
         ...
         moved.move(direction, toFill, toReturn.spaces);
         toReturn.allBlocks.add(moved);
   ...
   */
   ...
   public static void main(String[] args){
      ...
      pieces.add(new Block(1,1,0,0));
      pieces.add(new Block(2,2,0,1));
      ...
      brd.setPath(brd, new Block(0,0,9,9), Pair.getInstance(0,2));
      brd.setPath(new Board(new HashSet<Block>()), new Block(1,1,1,1), Pair.getInstance(0,1));
      ...
      Board brd1 = brd.makeMove(new Block(1,1,2,0), Pair.DOWN);
      Board brd2 = brd.makeMove(new Block(1,1,2,0), Pair.getInstance(0,1));
      Board brd3 = brd.makeMove(b, Pair.DOWN);
      Board brd4 = brd.makeMove(new Block(2,2,0,1), Pair.DOWN);
      ...
      System.out.println("Moving new " + new Block(2,2,0,1) + " in direction " + Pair.DOWN + " : " + brd4);
      ...
      brdClone.setPath(brd1, new Block(0,0,0,0), null);
      System.out.println("\nOriginal:");
      System.out.println("Parent Board: " + brd.getParent());
      System.out.println("Moved Block: " + brd.getMovedBlock());
      System.out.println("Moved direction: " + brd.getMovedDirection());
      ...
      bigBlock.getBlocks().add(new Block(10,10,0,0));
      try{bigBlock.isOK();}
      catch(IllegalStateException i){System.out.println(i.getMessage());}
      
      HashSet<Block> overlapBlocks = new HashSet<Block>();
      overlapBlocks.add(new Block(3,3,0,0));
      overlapBlocks.add(new Block(1,1,0,0));
